  ...
  return (
    ...
    <div className="top-nav  bg-slate-100 text-center  text-gray-500 text-sm  flex-items__center justify-center  flex-col space-y-2 py-4 md:space-y-0 md:flex-row md:justify-between  md:px-12 md:py-2">
      <div className="contact space-y-2 md:space-y-0 md-flex-items__center">
        <p>
          Order On Phone:
          <span className="text-lime-500 font-bold px-2">
            <button>+234 444 44</button>
          </span>
        </p>
        {/* dotted line partiton on top nav */}
        ...
        <p className="flex-items__center">
          ...
          <span>
            <button className="px-2 tracking-wide">Hello@you.Ng</button>
          </span>
        </p>
      </div>
      <div className="reach md-flex-items__center">
        <div className="flex-items__center space-x-6 md:space-x-0 md:pr-0">
          <p className="flex-items__center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
